...
public class Aplicacion extends Application {
	...
	public void ventanaPrincipalComprador() {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Aplicacion.class
					.getResource("/co/uniquindio/programacion3/subasta/view/PrincipalComprador.fxml"));
	...
	public void ventanaPrincipalAnunciante() {
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Aplicacion.class
					.getResource("/co/uniquindio/programacion3/subasta/view/PrincipalAnunciante.fxml"));
